                    ...
                    <div class="grid-container">
                        <div class="grid-x grid-margin-x">
                            <div class="cell medium-6">
                                ...
                                <!-- Form Task -->
                                <?php $post_id = isset($_GET['post_id']) ? $_GET['post_id'] : ''; ?>
                                ...
                                <div class="contact__links">
                                    ...
                                    <?php if ($phone = get_field('phone', 'options')): ?>
                                        <p class="contact-link contact-link--phone"><a
                                                href="tel:<?php echo sanitize_number($phone); ?>"><?php echo $phone; ?></a></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="cell medium-6">
                                ...
                                <div class="cell contact__map-wrap">
                                    <div class="acf-map contact__map">
                                        <div class="marker" data-lat="<?php echo $location['lat']; ?>"
                                            ...
                                            data-marker-icon="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/map-marker.png">
